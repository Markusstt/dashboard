...
class DashboardItem {
  ...
  constructor(data, container = '.dashboard__list', view = 'weekly') {
      this.data = data;
  ...
  _createMarkup() {
      ...
      this.container.insertAdjacentHTML('beforeend', `
          <li class="dashboard__item dashboard__item--${id}">
      ...
      this.prev = this.container.querySelector(`.dashboard__item--${id} .tracking-card__meta`);
  }
